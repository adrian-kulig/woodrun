...
<fieldset rel="step-1">
	...
	<div>
		...
		<p>
			<label for="time">Termin wycieczki</label>
			
			<select name="time" id="time">
				
				<option class="default">Wybierz termin wycieczki...</option>
...
<fieldset rel="step-2">
	<legend>Uczestnicy wyjazdu</legend>
	<div>
		<p>
