    ...
    <div id="content">
        <div>
            <article class="single-entry">
                <a href="<?php echo get_permalink($nextPostID); ?>" title="Zobacz wszystkie"><?php _e('Zobacz następny', 'woodrun'); ?></a>
                <?php the_post();
                the_content(); ?>
                    ...
                    <form id="offer_form" data-postID="<?php echo get_the_ID();?>">
                        ...
                        <div class="order-details">
                            ...
                            <div class="confirm-button-end">
                                <button id="confirm-button-end"> <?php _e('Zamawiam z obowiązkiem zapłaty', 'woodrun'); ?></button>
                            </div>
                        </div>
            ...
            <aside class="sidebar">
                ...
                <p class="return"><a href="<?php echo get_permalink($parentCategory); ?>" title="Powrót do listy ofert"><?php _e('Powrót do listy ofert', 'woodrun'); ?></a></p>
            </aside>
